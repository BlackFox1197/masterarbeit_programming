...
class ss_encoded_dataset_full(Dataset):
    ...
    def __init__(self, sound_stream_path: None | str = None,
                 ...
                 seconds = 3.5, sr=16000, device="cpu", one_hot_encoded = True, csvPath: str | None = None, clip_path: str | None = None):
        ...
        self.encoded_dataset = ss_encoded_dataset(data_set=paths_dataset, sound_stream=soundstream, device=device,
                                                  num_labels=num_labels, one_hot_encoded=one_hot_encoded, csvPath=csvPath, clip=clip)
    ...
    def init_clip(self, clip_path) -> EncoderDownmapping:
