...
class CombinedEmoDataSet_7_emos(Dataset):
    ...
    def loadMesd(self) -> Tuple:
        ...
        def lamb(filename):
            ...
            return label
        paths, emotions = self.crawl(lamb, self.directory_mesd)
    ...
    def loadCafe(self) -> Tuple:
        ...
        paths, emotions = self.crawl(lamb, self.directory_cafe)
        return paths, emotions
    ...
    def loadRavdess(self) -> Tuple:
        ...
        paths, emotions = self.crawl(lamb, self.directory_ravdess)
    ...
    def loadTess(self):
        ...
        paths, emotions = self.crawl(lamb, self.directory_tess)
        return paths, emotions



    def crawl(self, labelLambda: callable, directory):
        paths = []
        emotions = []
